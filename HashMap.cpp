...
//  tarea3
//
//  Created by Alberto Limón on 24/10/23.
//
...
template <class K, class V>
const std::vector<std::string>& HashMap<K,V>::getStatus() const {
    return _status;
}

template <class K, class V>
const std::vector<K>& HashMap<K,V>::getKeys() const {
    return _keys;
}

template <class K, class V>
const std::vector<V>& HashMap<K,V>::getValues() const {
    return _values;
}
